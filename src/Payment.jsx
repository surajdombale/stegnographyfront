...
const Payment = () => {
  ...
  const handleCardToggleChange = () => {
    
    setCardToggle(!cardToggle);
    setpaypalToggle(false);
  };
  const handlePayToggleChange = () => {

    setCardToggle(false);
    setpaypalToggle(!paypalToggle);
  };
  useEffect(()=>{
if(!isLoggedIn.isLoggedIn){
  nav("/login/Login First")
}
  },[])
  return (
    <div >
          ...
          <div class="accordion-item mb-3">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapseCC" aria-expanded="false">
                <input class="form-check-input" type="radio" checked={cardToggle} onClick={handleCardToggleChange} name="payment" id="payment1"/>
          ...
          <div class="accordion-item mb-3 border">
            <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
              <div class="form-check w-100 collapsed" data-bs-toggle="collapse" data-bs-target="#collapsePP" aria-expanded="false">
                <input class="form-check-input" type="radio" checked={paypalToggle} name="payment" id="payment2" onClick={handlePayToggleChange}/>
      ...
      <div class="col-lg-3">
        <div class="card position-sticky top-0">
          <div class="p-3 bg-light bg-opacity-10">
            ...
            <div class="d-flex justify-content-between mb-1 small">
              <span>G.S.T :</span> <span>$0.01</span>
            </div>
            <div class="d-flex justify-content-between mb-1 small">
              <span>Coupon (Code: NEWYEAR)</span> <span class="text-danger">-$1.00</span>
            </div>
            {/* <hr> */}
            <div class="d-flex justify-content-between mb-4 small">
              <span>TOTAL</span> <strong class="text-dark">$9.00</strong>
            </div>
            <div class="form-check mb-1 small">
              <input class="form-check-input" type="checkbox" value="" id="tnc"/>
              <label class="form-check-label" for="tnc">
                I agree to the <a href="/payment">terms and conditions</a>
              </label>
            </div>
            <div class="form-check mb-3 small">
              <input class="form-check-input" type="checkbox" value="" id="subscribe"/>
              <label class="form-check-label" for="subscribe">
                Get emails about product updates and events. If you change your mind, you can unsubscribe at any time. <a href="/payment">Privacy Policy</a>
              </label>
            </div>
            <a href="/payotp"><button class="btn btn-primary w-100 mt-2">Place order</button></a>
          </div>
        </div>
      </div>
    </div>
